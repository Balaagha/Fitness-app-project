...
2026-05-24 15:57 [impl] Welcome refactor: TopBar (progress+Keç) + primary CTA pager-dən kənara overlay-ə çıxdı, button fixed qalır; pager yalnız bg+hero swipe; TypewriterText hər səhifə (text,isActive) ilə reset olur
